              ...
              children: [
                IconButton(
                  onPressed: () {
                    ...
                    context.read<StockDataState>().handleSetFavourite(stock,context);
                  },
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(stock.symbol,style:Theme.of(context).textTheme.headline6),
                              const SizedBox(
                                height: 5,
                              ),
                              FittedBox(fit: BoxFit.fitWidth,child: Text(stock.name))
                            ],
                          ),
                        ),
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(stock.marketPrice.toString(), style:Theme.of(context).textTheme.headline6),//style:const TextStyle(fontWeight:FontWeight.bold,fontSize: )),
                              const SizedBox(
                                height: 5,
                              ),
